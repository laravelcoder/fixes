...
@media only screen and (max-width: 1024px) and (min-width: 768px) {.responsive.html_mobile_menu_tablet.html_header_top.html_header_sticky #top #wrap_all #main {padding-top: inherit; } }
...
@media only screen and (min-width : 1824px) {.responsive.html_mobile_menu_tablet.html_header_top.html_header_sticky #top #wrap_all #main {padding-top: 173px;} }
